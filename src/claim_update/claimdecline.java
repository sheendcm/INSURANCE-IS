 ...
 */
@WebServlet("/declineclaim")
public class claimdecline extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{		
			PreparedStatement statusupdate = (PreparedStatement) conn.prepareStatement("update r_claim_approval_status_details \r\n" + 
					"set cas_status = 'Declined', cas_completion='Completed', cas_datecompleted='"+modifiedDate1+"' where cas_id ='"+asid1+"' ");
