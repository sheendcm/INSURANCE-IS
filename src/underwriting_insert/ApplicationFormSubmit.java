...
public class ApplicationFormSubmit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{		PreparedStatement afdetails = (PreparedStatement) conn.prepareStatement("INSERT INTO r_application_form_details(af_applicationnumber, af_clientnumber, af_dateapplied) VALUES ('"+AF_applicationnumber+"','"+AF_clientnumber+"','"+AF_dateapplied+"')");
				...
				PreparedStatement msdetails = (PreparedStatement) conn.prepareStatement("insert into r_medical_status_details (ms_ref_c_id, ms_status, ms_remarks) values ((SELECT MAX(c_id) from r_client_details),'Pending','')");
				msdetails.executeUpdate();
				PreparedStatement apdetails = (PreparedStatement) conn.prepareStatement("insert into r_application_progress_details (ap_ref_c_id, ap_requirements, ap_medical, ap_status) values ((SELECT MAX(c_id) from r_client_details),'Pending','Pending','Pending')");
				apdetails.executeUpdate();
