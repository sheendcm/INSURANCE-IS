 ...
 */
@WebServlet("/legalapprove")
public class UpdateLegalStatus extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateLegalStatus() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{		PreparedStatement updatehealthy = (PreparedStatement) conn.prepareStatement("update r_claim_legal_status_details \r\n" + 
				"set cls_status = 'Approved in Legal' , cls_remarks='"+remarks+"' where cls_id ='"+cls_id+"' ");
