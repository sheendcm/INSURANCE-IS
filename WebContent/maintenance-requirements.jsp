...
<section>
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <li><a href="maintenance-dashboard.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        ...
        <ul class="children" style="display: block">
            <li class="active"><a href="maintenance-requirements.jsp"><i class="fa fa-caret-right"></i>For Application Approval</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="glyphicon glyphicon-list-alt"></i> Requirements</h2>
        ...
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <col width="35%">
              ...
              <%
			try{ 
				String query = "SELECT * FROM r_requirements_details ORDER BY req_dateadded DESC ";
				Statement stmt = conn.createStatement();
				ResultSet rs = stmt.executeQuery(query);
				while(rs.next())
				{
				String dateindb = rs.getString("req_dateadded");
    			String modifieddate = dateindb.substring(0, 10);
			%>
                 <tr>
                    <td style="display:none;"><%out.print(rs.getInt("req_id")); %></td>
                    <td><%out.print(modifieddate); %></td>
                    <td><%out.print(rs.getString("req_name")); %></td>
                    <td><%out.print(rs.getString("req_description")); %></td>
                    <td>
					<a class ="btn btn-warning mybtn tooltips btnEditReq" data-placement="top" data-toggle="modal" title="Edit" href="#modalEditRequirements" ><i class="glyphicon glyphicon-pencil"></i></a>
