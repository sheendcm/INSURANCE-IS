...
<section>
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <li><a href="maintenance-dashboard.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        ...
        <ul class="children" style="display: block">
            ...
            <li class="active"><a href="maintenance-user-management-underwriting.jsp"><i class="fa fa-caret-right"></i> Underwriting</a></li>
          </ul>
        </li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-user"></i> Underwriting Department</h2>
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Underwriting Department</li>
        </ol>
      </div>
    </div>
        ...
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <col width="18%">
              ...
              <%
			try{ 
				String query = "SELECT * FROM r_system_user_details sud LEFT JOIN r_system_user_personal_details supd ON supd.supd_id=sud.sud_ref_supd_id WHERE sud.sud_department='Underwriting' ";
