      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href="" style="background-color: #DB241E;"><i class="fa fa-list-alt"></i> <span>List of Application</span></a>
          <ul class="children" style="display: block">
            ...
            <li class="active"><a href="declined-application.jsp" style="color: #DB241E;"><i class="fa fa-caret-right"></i> Declined</a></li>
          </ul>
        </li>
    ...
    <div class="contentpanel">
     ...
     <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#db241e; height:60px; padding:20px;">
              <h4 class="panel-title" align="center" style="font-size:90%; color:white;">DECLINED</h4>
            </div>
			<div class="panel-body">
			<div class="row" style="padding-right:20px; padding-left:20px; padding-top:25px;">
              <div class="table-responsive">
          <table class="table table-bordered mb30" id="DeclinedApplication">
  			<col width="80">
  			<col width="100">
  			<col width="200">
  			<col width="200">
...
$('.btnSendMsg').click( function() {
    var table2 = document.getElementById('DeclinedApplication'); 
    for(var i = 1; i < table2.rows.length; i++)
    {
      table2.rows[i].cells[6].onclick = function()
      {
	        ...
	        var email = document.getElementById('DeclinedApplication').rows[indexedituser].cells.item(5).innerHTML
	        document.getElementById('email').value = email;
	        document.getElementById('subject').value = "Prulife UK Life Insurance Application";
	        document.getElementById('content').value = "Sorry! Your application is declined!";
    	  	indexedituser = this.parentElement.rowIndex;
