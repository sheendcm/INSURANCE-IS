  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
     ...
     <ul class="nav nav-pills nav-stacked nav-bracket">
      ...
      <li  class="active"><a href="cashiering-add-payment.jsp"><i class="fa fa-plus"></i> <span>Add Payments</span></a></li>
      ...
      <tbody>
        ...
        while(rs.next())
        {
         ...
         <tr>
          ...
          <td>
           <a class ="btn btn-info mybtn tooltips" data-placement="top" data-toggle="modal" title="View Payment Info" href="#modalAddPayments" ><i class="glyphicon glyphicon-eye-open"></i></a>
         </td>
...
<div class="modal fade" id="modalAddPayments" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-content" style="width:100%;">
      ...
      <div class="modal-body">
        <div class="panel-body">
            ...
            <!-- haha -->
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" placeholder="Balance" id="balance" class="form-control">
                  </div>
                   <div class="col-sm-2"></div>
                </div>
                ...
                <div class="form-group">
                   <div class="col-sm-2"></div>
                  <div class="col-sm-8">
                  <input type="text" placeholder="Payment Amount" id="paymentAmount" class="form-control">
                  </div>
                   <div class="col-sm-2"></div>
                </div>
                   ...
                   <div class="form-group">
                     <div class="col-sm-2"></div>
                  <div class="col-sm-8">
                  <input type="text" placeholder="Change" id="paymentChange" class="form-control">
                  </div>
                   <div class="col-sm-2"></div>
                </div>
            ...
            <!-- hehe -->
              <br>
          <div class="table-responsive">
            <div id="table1_wrapper" class="dataTables_wrapper no-footer"><div class="dataTables_length" id="table1_length"></div><div id="table1_filter" class="dataTables_filter"></div><table class="table dataTable no-footer" id="table1" style="font-size:85%;" role="grid" aria-describedby="table1_info">
        ...
        <col width="12%">
                 ...
                 <tr role="row"><th style="display: none; width: 0px;" class="sorting_asc" tabindex="0" aria-controls="table1" rowspan="1" colspan="1" aria-sort="ascending" aria-label=": activate to sort column ascending"></th>
                  <th class="sorting" tabindex="0" aria-controls="table1" rowspan="1" colspan="1" aria-label="Payment Number: activate to sort column ascending" style="width: 149px;">Payment Number</th>
                  <th class="sorting" tabindex="0" aria-controls="table1" rowspan="1" colspan="1" aria-label="Payment Date: activate to sort column ascending" style="width: 125px;">Payment Date</th>
                  <th class="sorting" tabindex="0" aria-controls="table1" rowspan="1" colspan="1" aria-label="Policyowner: activate to sort column ascending" style="width: 173px;">Amount Paid</th>
                </tr>
              </thead>
              <tbody>
              ...
              <tr role="row" class="odd">
                    <td style="display:none;" class="sorting_1">1</td>
                    <td>0000-1</td>
                    <td>2018-10-24 15:47</td>
                    <td>237500</td>
                
                 </tr>
              </tbody>
           </table><div class="dataTables_info" id="table1_info" role="status" aria-live="polite">Showing 1 to 2 of 2 entries</div></div>
