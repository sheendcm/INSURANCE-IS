...
<section>
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href=""><i class="fa fa-list"></i> <span>List of Completed Medical</span></a>
          <ul class="children" style="display: block">
            <li class="active"><a href="medical-department-approved.jsp"><i class="fa fa-caret-right"></i> Approved in Medical</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-check"></i> Approved in Medical</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
           <li><a href="#">Medical Department</a></li>
          <li class="active"> Approved in Medical</li>
        </ol>
      </div>
    </div>
