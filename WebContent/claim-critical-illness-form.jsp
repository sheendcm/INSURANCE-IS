...
<section>
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href=""><i class="fa fa-pencil"></i> <span>Claim Form</span></a>
          <ul class="children" style="display: block">
            ...
            <li class="active"><a href="claim-critical-illness-form.jsp"><i class="fa fa-caret-right"></i> Critical Illness</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-pencil"></i> Claimant Statement <span>Critical Illness</span></h2>
      <div class="breadcrumb-wrapper">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Critical Illness</li>
        </ol>
      </div>
    </div>
...
<div class="panel-heading">
		...
		.mybutton1:hover
		{
            ...
            <div class="col-md-4" align="right">
                  <button class="btn btn-primary mybutton1" id="btnCriticalIllnessSave" style="margin-right:10px;"> Save</button>
                </div>
            </div>
</div>
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-1"></div>
                ...
                <div class="form-group myfg">
              <label class="col-sm-4 control-label mylabel" align="right">Details of Illness</label>
              <div class="col-sm-8">
                <textarea name="illnessdetails" id="illnessdetails" class="form-control" rows="4"></textarea>
              </div>
            </div>
            <div class="form-group myfg">
					  <label class="col-sm-4 control-label mylabel" align="right">First Consultation</label>
					  <div class="input-group" style="padding-left: 10px; padding-right: 10px;">
					<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="firstconsultation">
					<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				  </div>
					</div>
					<div class="form-group myfg">
              <label class="col-sm-4 control-label mylabel" align="right">Symptoms experienced</label>
              <div class="col-sm-8">
                <textarea name="symptomsexperienced" id="symptomsexperienced" class="form-control" rows="4"></textarea>
              </div>
            </div>
            <div class="form-group myfg">
					  <label class="col-sm-4 control-label mylabel" align="right">Symptoms Begin</label>
					  <div class="input-group" style="padding-left: 10px; padding-right: 10px;">
					<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="symptomsbegin">
					<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				  </div>
					</div>
        ...
        <div class="panel-body">
          <div class="row">
            <div class="form-group col-md-4 myfg">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="CIHD_hospitalname" id="CIHD_hospitalname" class="form-control mytextbox" />
                  </div>
					</div><br>
          <div class="form-group myfg">
              <label class="col-sm-4 control-label mylabel" align="right">Hospital Address</label>
              <div class="col-sm-8">
                <textarea name="CIHD_hospitaladdress" id="CIHD_hospitaladdress" class="form-control" rows="4"></textarea>
              </div>
            </div>
			...
			<div class="form-group col-md-4 myfg">
              <div class="form-group myfg">
					  ...
					  <div class="input-group" style="padding-left: 10px; padding-right: 10px;">
					<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="CIHD_admissiondate">
					<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				  </div>
					</div>
          <div class="form-group myfg">
          ...
          <div class="col-sm-8">
            <input type="text" name="CIHD_admissionnum" id="CIHD_admissionnum" class="form-control mytextbox" />
          </div>
        </div>
        <div class="form-group myfg">
        <label class="col-sm-4 control-label mylabel" align="right">Days of Confinement</label>
        <div class="col-sm-8">
          <input type="text" name="CIHD_daysconfine" id="CIHD_daysconfine" class="form-control mytextbox" />
        </div>
      </div>
			...
			<div class="form-group col-md-4 myfg">
                  <div class="form-group myfg">
					  ...
					  <div class="input-group" style="padding-left: 10px; padding-right: 10px;">
					<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="CIHD_dischargedate">
					<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				  </div>
					</div>
						<div class="form-group myfg">
						  ...
						  <div class="col-sm-8">
							<input type="text" name="CIHD_wardnum" id="CIHD_wardnum" class="form-control mytextbox" />
						  </div>
						</div>
            <div class="form-group myfg">
            <label class="col-sm-4 control-label mylabel" align="right">Final Diagnosis</label>
            <div class="col-sm-8">
              <input type="text" name="CIHD_diagnosis" id="CIHD_diagnosis" class="form-control mytextbox" />
            </div>
          </div>
...
<script>
  ...
  jQuery(".select1").select2({
    ...
    jQuery('#CIHD_admissiondate').datepicker();
    jQuery('#firstconsultation').datepicker();
    jQuery('#symptomsbegin').datepicker();
    jQuery('#CIHD_dischargedate').datepicker();
...
$(document).ready(function (){
			...
			$("#btnCriticalIllnessSave").click(function() {
			
			var sud_id = $('#sud_id').val();
			var policyid = $('#policyid').val();
			var CIHD_hospitalname = $('#CIHD_hospitalname').val();
			var CIHD_hospitaladdress = $('#CIHD_hospitaladdress').val();
			var CIHD_admissiondate = $('#CIHD_admissiondate').val();
			var CIHD_admissionnum = $('#CIHD_admissionnum').val();
			var CIHD_daysconfine = $('#CIHD_daysconfine').val();
			var CIHD_dischargedate = $('#CIHD_dischargedate').val();
			var CIHD_wardnum = $('#CIHD_wardnum').val();
			var CIHD_diagnosis = $('#CIHD_diagnosis').val(); 
			
			var illnessdetails = $('#illnessdetails').val();
			var firstconsultation = $('#firstconsultation').val();
			var symptomsexperienced = $('#symptomsexperienced').val();
			var symptomsbegin = $('#symptomsbegin').val();
			...
			$.ajax({
				...
				{	
					sud_id:sud_id,
					policyid:policyid,
					CIHD_hospitalname:CIHD_hospitalname,
					CIHD_hospitaladdress:CIHD_hospitaladdress,
					CIHD_admissiondate:CIHD_admissiondate,
					CIHD_admissionnum:CIHD_admissionnum,
					CIHD_daysconfine:CIHD_daysconfine,
					CIHD_dischargedate:CIHD_dischargedate,
					CIHD_wardnum:CIHD_wardnum,
					CIHD_diagnosis:CIHD_diagnosis,
					illnessdetails:illnessdetails,
					firstconsultation:firstconsultation,
					symptomsexperienced:symptomsexperienced,
					symptomsbegin:symptomsbegin
					
				},
				url:'criticalillnessinsert',
