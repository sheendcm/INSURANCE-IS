...
<section>
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href=""><i class="fa fa-list"></i> <span>List of Completed Legal</span></a>
          <ul class="children" style="display: block">
            ...
            <li class="active"><a href="legal-department-declined.jsp"><i class="fa fa-caret-right"></i> Declined in Legal</a></li>
          </ul>
        </li>
      </ul>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-times"></i> Declined in Legal</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
           <li><a href="#">Legal Department</a></li>
          <li class="active">Declined in Legal</li>
        </ol>
      </div>
    </div>
