...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="client-policy-details-view.jsp?id=<%out.print(rs.getInt("c_id")); %>"><i class="fa fa-check-square-o"></i> <span>Policy Details</span></a></li>
        <li class="active"><a href="client-plan-and-benefits-view.jsp?id=<%out.print(rs.getInt("c_id")); %>"><i class="fa fa-check-square-o"></i> <span>Plan and Benefits</span></a></li>
      </ul>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-plus"></i>Plan and Benefits </h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
          <li class="active">Plan and Benefits</li>
        </ol>
      </div>
    </div>
         ...
         <div class="table-responsive">
          <table class="table table-bordered mb30">
            ...
            <tbody>
             <%
			try{ 
				String query1 = "select * from client_details cd INNER JOIN policy_information_details pid on pid.pi_id=cd.c_ref_pi_id INNER JOIN benefit_details bd  on bd.benefit_ref_pi_id=pid.pi_id where cd.c_id="+cid+" ";
			...
			%>
              <tr>
                <td><%out.print(rs1.getString("benefit_name")); %></td>
                <td><%out.print(rs1.getString("benefit_amount")); %></td>
              </tr>
              <%
				}
				%>
