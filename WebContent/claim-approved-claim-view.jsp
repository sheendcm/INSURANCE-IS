...
<section>
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-parent active"><a href=""><i class="fa fa-list"></i> <span>List of Claim</span></a>
          <ul class="children" style="display: block">
            <li class="active"><a href="claim-approved-claim-view.jsp"><i class="fa fa-caret-right"></i> Issued Claim</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-check"></i>Approved Claim </h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
           <li><a href="#">Claim</a></li>
          <li class="active">Approved Claim</li>
        </ol>
      </div>
    </div>
