...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href=""><i class="fa fa-list"></i> <span>List of Completed Medical</span></a>
          <ul class="children" style="display: block">
            <li><a href="medical-department-approved.jsp"><i class="fa fa-caret-right"></i> Approved in Medical</a></li>
            <li class="active"><a href="medical-department-declined.jsp"><i class="fa fa-caret-right"></i> Declined in Medical</a></li>
          </ul>
        </li>
      </ul>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-times"></i> Declined in Medical</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
           <li><a href="#">Medical Department</a></li>
          <li class="active">Declined in Medical</li>
        </ol>
      </div>
    </div>
