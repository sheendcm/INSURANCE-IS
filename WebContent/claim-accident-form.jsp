...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="nav-parent nav-active active"><a href=""><i class="fa fa-pencil"></i> <span>Claiming Form</span></a>
          <ul class="children" style="display: block">
            ...
            <li class="active"><a href="claim-accident-form.jsp"><i class="fa fa-caret-right"></i> Accident Claim</a></li>
          </ul>
        </li>
 ...
 <%
    ...
    <div class="pageheader">
      <h2><i class="fa fa-plus"></i> Claimant Statement <span>Accident Claim</span></h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
          <li><a href="#">Claiming Form</a></li>
          <li class="active">Accident Claim</li>
        </ol>
      </div>
    </div>
...
<div class="panel-heading">
		...
		.mybutton1:hover
		{
            ...
            <div class="col-md-4" align="right">
                  <button class="btn btn-primary mybutton1" id="btnAccidentSave" style="margin-right:10px;"> Save</button>
                </div>
            </div>
</div>
              ...
              <div id="basicWizard" class="basic-wizard">
                ...
                <ul class="nav nav-pills nav-justified">
                  <li class="active"><a href="#basicinfo" data-toggle="tab"> Claiming Information</a></li>
                   <li><a href="#accident" data-toggle="tab"> Accident Details</a></li>
...
<div class="tab-pane" id="accident">
	<div class="panel panel-default" style="border-width:1px; border-style:solid; border-color:#e4e7ea;">
        <div class="panel-heading"  style="background-color:#bdbdbd; padding-top:5px;padding-bottom: 5px;">
          <div class="panel-btns">
            <a href="" class="minimize">&minus;</a>
        ...
        <div class="panel-body">
          <div class="row">
            <div class="col-md-1"></div>
                <div class="form-group col-md-8 myfg">
                <div class="form-group myfg" style="margin-bottom:0px;">
					  <label class="col-sm-4 control-label mylabel" align="right">Date and Time of Accident</label>
					  <div class="col-md-8">
					  <div class="col-md-12" style="padding:0px; margin-bottom:5px;">
					  	<div class="input-group">
							<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="accidentdate">
							<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
						  </div>
					  </div>
					  ...
					  <div class="input-group mb15">
		                ...
		                <div class="bootstrap-timepicker"><input id="timepicker" type="text" class="form-control" id="accidenttime"/></div>
		              </div>
					  </div>
					  </div>
				 ...
				 <div class="form-group myfg">
                  <label class="col-sm-4 control-label mylabel" align="right">Place of Accident</label>
                  <div class="col-sm-8">
                    <input type="text" name="accidentplace" id="accidentplace" class="form-control mytextbox" />
                  </div>
                </div>
                <div class="form-group myfg">
              <label class="col-sm-4 control-label mylabel" align="right">Cause of Accident</label>
              <div class="col-sm-8">
                <textarea name="accidentcause" id=""accidentcause"" class="form-control" rows="3"></textarea>
              </div>
            </div><div class="form-group myfg">
                  <label class="col-sm-4 control-label mylabel" align="right">Extent of Accident</label>
                  <div class="col-sm-8">
                    <input type="text" name="accidentextent" id="accidentextent" class="form-control mytextbox" />
                  </div>
                </div>
                <div class="form-group myfg">
              <label class="col-sm-4 control-label mylabel" align="right">Details of Accident</label>
              <div class="col-sm-8">
                <textarea name="accidentdetails" id="accidentdetails" class="form-control" rows="3"></textarea>
              </div>
            </div>
        ...
        <div class="panel-body">
          <div class="row">
            <div class="form-group col-md-4 myfg">
                  ...
                  <div class="col-sm-8">
                    <input type="text" name="ACHD_hospitalname" id="ACHD_hospitalname" class="form-control mytextbox" />
                  </div>
					</div><br>
          <div class="form-group myfg">
              <label class="col-sm-4 control-label mylabel" align="right">Hospital Address</label>
              <div class="col-sm-8">
                <textarea name="ACHD_hospitaladdress" id="ACHD_hospitaladdress" class="form-control" rows="4"></textarea>
              </div>
            </div>
			...
			<div class="form-group col-md-4 myfg">
              <div class="form-group myfg">
					  ...
					  <div class="input-group" style="padding-left: 10px; padding-right: 10px;">
					<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="ACHD_admissiondate">
					<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				  </div>
					</div>
          <div class="form-group myfg">
          ...
          <div class="col-sm-8">
            <input type="text" name="ACHD_admissionnum" id="ACHD_admissionnum" class="form-control mytextbox" />
          </div>
        </div>
        <div class="form-group myfg">
        <label class="col-sm-4 control-label mylabel" align="right">Days of Confinement</label>
        <div class="col-sm-8">
          <input type="text" name="ACHD_daysconfine" id="ACHD_daysconfine" class="form-control mytextbox" />
        </div>
      </div>
			...
			<div class="form-group col-md-4 myfg">
                  <div class="form-group myfg">
					  ...
					  <div class="input-group" style="padding-left: 10px; padding-right: 10px;">
					<input type="text" class="form-control" placeholder="mm/dd/yyyy" id="ACHD_dischargedate">
					<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
				  </div>
					</div>
						<div class="form-group myfg">
						  ...
						  <div class="col-sm-8">
							<input type="text" name="ACHD_wardnum" id="ACHD_wardnum" class="form-control mytextbox" />
						  </div>
						</div>
            <div class="form-group myfg">
            <label class="col-sm-4 control-label mylabel" align="right">Final Diagnosis</label>
            <div class="col-sm-8">
              <input type="text" name="ACHD_diagnosis" id="CIHD_diagnosis" class="form-control mytextbox" />
            </div>
          </div>
...
<script>
  ...
  jQuery(".select1").select2({
    ...
    jQuery('#ACHD_admissiondate').datepicker();
    jQuery('#ACHD_dischargedate').datepicker();
    jQuery('#accidentdate').datepicker();
...
$(document).ready(function (){
			...
			$("#btnAccidentSave").click(function() {
			
			var sud_id = $('#sud_id').val();
			var policyid = $('#policyid').val();
			var ACHD_hospitalname = $('#ACHD_hospitalname').val();
			var ACHD_hospitaladdress = $('#ACHD_hospitaladdress').val();
			var ACHD_admissiondate = $('#ACHD_admissiondate').val();
			var ACHD_admissionnum = $('#ACHD_admissionnum').val();
			var ACHD_daysconfine = $('#ACHD_daysconfine').val();
			var ACHD_dischargedate = $('#ACHD_dischargedate').val();
			var ACHD_wardnum = $('#ACHD_wardnum').val();
			var ACHD_diagnosis = $('#ACHD_diagnosis').val();
			
			var accidentdate = $('#accidentdate').val();
			var accidenttime = $('#accidenttime').val();
			var accidentplace = $('#accidentplace').val();
			var accidentcause = $('#accidentcause').val();
			var accidentextent = $('#accidentextent').val();
			var accidentdetails = $('#accidentdetails').val();
			...
			$.ajax({
				...
				{	
					sud_id:sud_id,
					policyid:policyid,
					ACHD_hospitalname:ACHD_hospitalname,
					ACHD_hospitaladdress:ACHD_hospitaladdress,
					ACHD_admissiondate:ACHD_admissiondate,
					ACHD_admissionnum:ACHD_admissionnum,
					ACHD_daysconfine:ACHD_daysconfine,
					ACHD_dischargedate:ACHD_dischargedate,
					ACHD_wardnum:ACHD_wardnum,
					ACHD_diagnosis:ACHD_diagnosis,
					accidentdate:accidentdate,
					accidenttime:accidenttime,
					accidentplace:accidentplace,
					accidentcause:accidentcause,
					accidentextent:accidentextent,
					accidentdetails:accidentdetails
					
					
				},
				url:'accidentclaiminsert',
