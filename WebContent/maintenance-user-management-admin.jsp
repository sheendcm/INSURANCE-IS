    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <li><a href="maintenance-dashboard.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        ...
        <ul class="children" style="display: block">
            <li class="active"><a href="maintenance-user-management-admin.jsp"><i class="fa fa-caret-right"></i> Admin</a></li>
    ...
    <div class="contentpanel">
      ...
      <div class="panel-heading">
            ...
            <div class="col-md-12" align="right">
			  	<button class="btn btn-primary mybutton1" href="#modalAddNewUser" data-toggle="modal" > Add new admin</button>
                </div>
            </div>
</div>
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <col width="25%">
              ...
              <%
			try{ 
				String query = "SELECT * FROM r_system_user_details sud LEFT JOIN r_system_user_personal_details supd ON supd.supd_id=sud.sud_ref_supd_id WHERE sud.sud_usertype='Admin' ";
			...
			%>
                 <tr>
                    <td style="display:none;"><%out.print(rs.getInt("supd_id")); %></td>
                    ...
                    <td>
					<a onclick="myFunction()" class ="btn btn-warning mybtn tooltips btnEditUser" data-placement="top" data-toggle="modal" title="Edit" href="#modalEditUser" ><i class="glyphicon glyphicon-pencil"></i></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#3F729B; height:50px;">
        ...
        <h4 class="modal-title" id="myModalLabel" style="color:white;font-size:100%;"> Add new admin</h4>
      </div>
      ...
      <div class="row" style="padding-top:20px;">
          ...
          <div class="row" style="padding-top:10px;">
           <label class="col-sm-4 control-label mylabel" align="right">Admin Name</label>
                  <div class="col-sm-8">
...
<!-- MODAL EDIT USER -->
            <div class="modal fade" id="modalEditUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header" style="background-color:#3F729B; height:50px;">
			        <button type="button" class="close" data-dismiss="modal" style="margin:0px" aria-hidden="true">&times;</button>
			        <h4 class="modal-title" id="myModalLabel" style="color:white;font-size:100%;"> Edit Admin</h4>
          ...
          <div class="row">
           <label class="col-sm-4 control-label mylabel" align="right">Civil Status</label>
                  <div class="col-sm-8" style="padding:0px;">
                    <select class="select1 col-sm-12 " id="User_CivilStatus_Edit" name="User_CivilStatus_Edit">
    ...
    for(var i = 1; i < table.rows.length; i++)
    {
      table.rows[i].cells[10].onclick = function()
      {
	        ...
	        document.getElementById('User_EmployeeNumber_Edit').value = User_EmployeeNumber_Edit;
    	  	...
    	  	var User_Name_Edit = document.getElementById('table1').rows[indexedituser].cells.item(3).innerHTML
	        document.getElementById('User_Name_Edit').value = User_Name_Edit;
	        
	        var User_EmailAddress_Edit = document.getElementById('table1').rows[indexedituser].cells.item(4).innerHTML
	        document.getElementById('User_EmailAddress_Edit').value = User_EmailAddress_Edit;
	        
	        var User_Gender_Edit = document.getElementById('table1').rows[indexedituser].cells.item(5).innerHTML
	        ...
	        var User_CivilStatus_Edit = document.getElementById('table1').rows[indexedituser].cells.item(6).innerHTML
	        $('#User_CivilStatus_Edit').val('Single');
	        
    	  	var User_Address_Edit = document.getElementById('table1').rows[indexedituser].cells.item(7).innerHTML
	        $('#User_Address_Edit').val(User_Address_Edit);
	        
	        var User_TelephoneNumber_Edit = document.getElementById('table1').rows[indexedituser].cells.item(8).innerHTML
	        document.getElementById('User_TelephoneNumber_Edit').value = User_TelephoneNumber_Edit;
	        
	        var User_MobileNumber_Edit = document.getElementById('table1').rows[indexedituser].cells.item(9).innerHTML
		...
		$("#btnSubmitUser").click(function() {
			...
			$.ajax({
				...
				success: function(result){
					...
					swal("Success!", "You added new Admin!", "success");
