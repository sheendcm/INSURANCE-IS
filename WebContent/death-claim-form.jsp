...
<title>Pru Life UK - Death Claim</title>
...
<section>
  ...
  <div class="leftpanelinner" style="padding-top:30px; ">     
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="active"><a href="death-claim-form.jsp"style="background-color: #DB241E;"><i class="fa fa-edit"></i> <span>Death Claim</span></a></li>
      ...
      <div class="row">
          ...
          <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#db241e; height:60px; padding:20px;">
              <h4 class="panel-title" align="center" style="font-size:90%; color:white;">DEATH CLAIM</h4>
            </div>
            ...
            <div class="panel-body panel-body-nopadding">
              ...
              <div id="basicWizard" class="basic-wizard">
                ...
                <ul class="nav nav-pills nav-justified">
				  ...
				  <li><a href="#beneficialowner" data-toggle="tab" style="font-size:85%;">Questionnaire</a></li>
				  ...
				  <li><a href="#personalhistory" data-toggle="tab" style="font-size:85%;">Beneficiary-Claimant</a></li>
            ...
            <div class="row">
				  ...
				  <div class="form-group">
                        <label class="col-sm-4 control-label" style="font-size:85%;">Full Name of the Deceased</label>
                        <div class="col-sm-8">
                          <input type="text" name="LI_surname" id="LI_surname" class="form-control input-sm mb15"  required/>
                        </div>
                      </div>
            ...
            <div class="row" id="BeneficialOwnerYes" style="display:none;"><br>
                ...
                <div class="row">
				  ...
				  <div class="col-md-10">
				                    <div class="panel panel-default">
            <div class="panel-heading" style="background-color:#db241e; height:30px; padding:5px;">
              <h4 class="panel-title" align="center" style="font-size:90%; color:white;">DEATH ABROAD QUESTIONNAIRE</h4>
            </div>			<div class="panel-body" style="border-style: solid; border-width: 1px; border-color: #EAECEF;">
            <div class="row"><br>
				  <div class="col-md-7" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-5 control-label" style="font-size:85%;">Other Names by which the deceased was known</label>
                        <div class="col-sm-7">
                          <input type="text" name="LI_employer" id="LI_employer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
		...
		<div class="row">
				  <div class="col-md-4" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Name of the Deceased's Spouse</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_employer" id="LI_employer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
				  ...
				  <div class="col-md-4" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Name of the Deceased's Father</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_natureofemployer" id="LI_natureofemployer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
                  ...
                  <div class="col-md-4" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Maiden Name of the Deceased's Mother</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_natureofemployer" id="LI_natureofemployer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
			...
			<div class="row">
				  <div class="col-md-4" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Last Address in the Philippines</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_employer" id="LI_employer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
				  ...
				  <div class="col-md-4" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">City/Province</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_natureofemployer" id="LI_natureofemployer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
                  ...
                  <div class="col-md-4" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Zipcode</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_natureofemployer" id="LI_natureofemployer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
			...
			<div class="row">
				  <div class="col-md-7" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Reason for leaving the Philippines</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_employer" id="LI_employer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
				  ...
				  <div class="col-md-5" style="padding:0;">
				  <div class="form-group">
                        <label class="col-sm-6 control-label" style="font-size:85%;">Date the deceased left the Philippines</label>
                        <div class="col-sm-6">
                          <input type="text" name="LI_natureofemployer" id="LI_natureofemployer" class="form-control input-sm mb15"  />
                        </div>
                      </div>
