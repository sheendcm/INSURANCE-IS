...
<section>
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <li><a href="maintenance-dashboard.jsp"><i class="fa fa-home"></i> <span>Dashboard</span></a></li>
        ...
        <ul class="children" style="display: block">
            ...
            <li class="active"><a href="maintenance-user-management-agent.jsp"><i class="fa fa-caret-right"></i> Agent</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-user"></i> Agent</h2>
    ...
    <div class="contentpanel">
      ...
      <div class="panel-heading">
            ...
            <div class="col-md-12" align="right">
			  	<button class="btn btn-primary mybutton1" href="#modalAddNewUser" data-toggle="modal" > Add new agent</button>
                </div>
            </div>
</div>
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <col width="25%">
              ...
              <%
			try{ 
				String query = "SELECT * FROM r_system_user_details sud LEFT JOIN r_system_user_personal_details supd ON supd.supd_id=sud.sud_ref_supd_id WHERE sud.sud_usertype='Agent' ";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#3F729B; height:50px;">
        ...
        <h4 class="modal-title" id="myModalLabel" style="color:white;font-size:100%;"> Add new agent</h4>
      </div>
      ...
      <div class="row" style="padding-top:20px;">
          ...
          <div class="row" style="padding-top:10px;">
           <label class="col-sm-4 control-label mylabel" align="right">Agent Name</label>
                  <div class="col-sm-8">
...
<!-- MODAL EDIT USER -->
            <div class="modal fade" id="modalEditUser" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      <div class="modal-header" style="background-color:#3F729B; height:50px;">
			        <button type="button" class="close" data-dismiss="modal" style="margin:0px" aria-hidden="true">&times;</button>
			        <h4 class="modal-title" id="myModalLabel" style="color:white;font-size:100%;"> Edit Agent</h4>
          ...
          <div class="row">
           <label class="col-sm-4 control-label mylabel" align="right">Civil Status</label>
                  <div class="col-sm-8" style="padding:0px;">
                    <select class="select1 col-sm-12 " id="User_CivilStatus_Edit">
                            <option value="" selected>Choose here ...</option>
                            <option value="Single">Single</option>
                            <option value="Married">Married</option>
                          </select>
		...
		$("#btnSubmitUser").click(function() {
			...
			$.ajax({
				...
				success: function(result){
					...
					swal("Success!", "You added new Agent!", "success");
