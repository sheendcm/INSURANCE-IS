...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="legal-department.jsp"><span class="pull-right badge badge-danger" style="background-color:#d9534f; color:white;">new</span><i class="fa fa-edit"></i> <span>Legal Evaluation</span></a></li>
        
        <li class="nav-parent nav-active active"><a href=""><i class="fa fa-list"></i> <span>List of Completed Legal</span></a>
          <ul class="children" style="display: block">
            <li class="active"><a href="legal-department-approved.jsp"><i class="fa fa-caret-right"></i> Approved in Legal</a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-check"></i> Approved in Legal</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
           <li><a href="#">Legal Department</a></li>
          <li class="active"> Approved in Legal</li>
        </ol>
      </div>
    </div>
