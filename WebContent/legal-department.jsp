...
<section>
  ...
  <div class="leftpanel">
    ...
    <div class="leftpanelinner" style="padding: 0px 0px;">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li class="active"><a href="legal-department.jsp"><span class="pull-right badge badge-danger" style="background-color:#d9534f; color:white;">new</span><i class="fa fa-edit"></i> <span> In Legal Department</span></a></li>
  ...
  <div class="mainpanel">
    ...
    <div class="pageheader">
      <h2><i class="fa fa-edit"></i> In Legal Department</h2>
      <div class="breadcrumb-wrapper">
        <span class="label">You are here:</span>
        <ol class="breadcrumb">
          <li><a href="#">La Vie Insurance</a></li>
           <li><a href="#">Legal Department</a></li>
          <li class="active">In Legal Department</li>
        </ol>
      </div>
    </div>
          ...
          <div class="table-responsive">
			...
			%>
                 <tr>
                    ...
                    <td>
					<a class ="btn btn-info mybtn tooltips" data-placement="top" data-toggle="modal" title="View Info" href="legal-department-view-info.jsp?id=<%out.print(rs.getInt("c_id")); %>" ><i class="glyphicon glyphicon-eye-open"></i></a>
   ...
   <!-- MODAL PROCEED TO MEDICAL -->
      ...
      <div class="row" style="padding-top:20px;">
          ...
          <div class="row" style="padding-top:10px;">
           <label class="col-sm-6 control-label mylabel" align="right"><strong>Date and Time Proceeded in Legal</strong></label>
                  <div class="col-sm-6">
...
$('.btnCompleteMedical').click( function() {
    ...
    for(var i = 1; i < table.rows.length; i++)
    {
      table.rows[i].cells[6].onclick = function()
      {
    	  	...
    	  	var ms_id = document.getElementById('table1').rows[indexedituser].cells.item(5).innerHTML
