  ...
  <div class="leftpanel">
    ...
    <div class="logopanel" style="margin-bottom:20px;">
      ...
      <ul class="nav nav-pills nav-stacked nav-bracket">
        ...
        <li><a href="cash-disbursement-dashboard.jsp"><i class="fa fa-plus"></i> <span>Dashboard</span></a></li>
    <li><a href="cash-disbursement-new.jsp"><i class="fa fa-plus"></i> <span>New Claim</span></a></li>
        ...
        <li class="active"><a href="cash-disbursement-audit-trail.jsp"><i class="glyphicon glyphicon-list"></i> <span>Audit Trail</span></a></li>
      </ul>
        ...
        <div class="panel-body">
          <div class="table-responsive">
            ...
            <col width="20%">
              ...
              <%
			try{ 
				String query = "SELECT * FROM r_audit_trail_details atd LEFT JOIN r_system_user_details sud ON sud.sud_id=atd.at_ref_sud_id LEFT JOIN r_system_user_personal_details supd ON supd.supd_id=sud.sud_ref_supd_id where sud.sud_department='Cash Disbursement' ORDER BY at_datetime DESC";
