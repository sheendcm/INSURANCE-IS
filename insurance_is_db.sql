...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2018 at 03:25 AM
...
--
-- Table structure for table `r_login_details`
--

CREATE TABLE `r_login_details` (
...
--
-- Dumping data for table `r_login_details`
--

INSERT INTO `r_login_details` (`login_id`, `login_username`, `login_password`) VALUES
(1, 'login', 'pass');
...
CREATE TABLE `r_medical_status_details` (
  ...
  `ms_remarks` varchar(200) NOT NULL,
...
INSERT INTO `r_medical_status_details` (`ms_id`, `ms_status`, `ms_remarks`, `ms_ref_c_id`) VALUES
(1, 'Healthy', 'Passed', 1),
(2, 'Healthy', 'Passed', 2);
...
(1, 'Mape', 'Sheena Mae', '', '', 'null', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'null', '', '', '', '', '', '', '', '', '', '', '', '', 'null', 'null', '', ''),
(2, 'Labayen', 'Raven', '', '', 'null', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'null', '', '', 'sheenmape09@gmail.com', '', '', '', '', '', '', '', '', '', 'null', 'null', '', '');
...
--
-- Indexes for table `r_login_details`
--
ALTER TABLE `r_login_details`
...
--
ALTER TABLE `r_agent_information_details`
  MODIFY `ai_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_application_form_details`
--
ALTER TABLE `r_application_form_details`
  MODIFY `af_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_application_requirements_details`
--
ALTER TABLE `r_application_requirements_details`
  MODIFY `ar_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_application_status_details`
--
ALTER TABLE `r_application_status_details`
  MODIFY `as_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_beneficial_owner_details`
--
ALTER TABLE `r_beneficial_owner_details`
  MODIFY `bo_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `r_life_insured_details`
  MODIFY `li_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_login_details`
--
ALTER TABLE `r_login_details`
...
--
ALTER TABLE `r_primary_beneficiary_details`
  MODIFY `pb_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `r_secondary_beneficiary_details`
--
ALTER TABLE `r_secondary_beneficiary_details`
  MODIFY `sb_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
